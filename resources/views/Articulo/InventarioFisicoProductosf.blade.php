    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="row">
                    <div class="col-lg-8">
                        <a href="{{url('mostrarinventariotodosf')}}" class="config" ><button class='btn btn-light' style="background:#3c46d3;color:#ffffff;text-align:center"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Volver</button></a>                     
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-primary">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('mostrarkardexarticuloporfechasf')}}" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-3">
