            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                            <div class="col-lg-2">  
                                <a href="{{url('pdfbanco/'.$banco->id_banco)}}" ><button class='btn btn-danger'><i  class="fa fa-file-pdf-o"></i> </button></a>
                                <a href="{{url('excelbanco')}}" ><button class='btn btn-success'><i  class="fa fa-file-excel-o"></i> </button></a>
                            </div>
                                         
                        
                        <table id="datatablemovbanco" class="table table-bordered table-hover table-striped table-sm">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-primary">
            <div class="modal-header panel-heading">
                ...
                <h4 class="modal-title">NUEVO INGRESO {{$ba->nombre_banco}}</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('crearmovbanco')}}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="hidden" name="id" value="{{$banco->id_banco}}">
...
<div class="modal fade" id="NuevoEgreso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-primary">
            <div class="modal-header panel-heading">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">NUEVO EGRESO {{$ba->nombre_banco}}</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('crearmovbanco')}}" autocomplete="off">
                    {{ csrf_field() }}
