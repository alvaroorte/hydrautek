...
@section('content')    
        <div class="modal-content panel-primary">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('librodeventas')}}" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12"><br>
                            <strong>N° AUTORIZACIÓN</strong> <strong style="color: red;">*</strong>
                            <input onkeyup="mayus(this);" type="text" name="autorizacion" class='form-control' required>
                        </div>
                    </div>
