                    ...
                    <div class="table-responsive">
                        ...
                        @else
                            <table id="" class="table table-bordered table-hover table-striped table-sm">
                                ...
                                <tbody>
                                    @foreach ($sql3 as $rese)
                                        <tr>
                                            <td style="text-align: center">{{$rese->detalle}}</td>
                                            <td style="text-align: center">{{$rese->cantidad}}</td>
                                            <td style="text-align: center">{{$rese->p_venta}}</td>
                                            <td style="text-align: center">{{$rese->sub_total}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>   
