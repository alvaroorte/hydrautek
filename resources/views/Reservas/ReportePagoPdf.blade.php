...
<body>
    <header>
      <div class="card">
        <a href="{{url('reservadetallada/'.$reserva->identificador)}}" class="config">
        ...
        <div class="car-body" style="text-align: center" >
          <span>Codigo: <b>{{$reserva->codigo_reserva}}</b></span>
        </div>
      </div>
    </header>
    <main><br>
          ...
          <table class="table table-bordered table-hover table-striped table-sm">
            ...
            <tbody style="text-align: center">
              ...
              <tr class="gradeC">
                ...
                <td style="text-align: right;">{{number_format($reserva->total-$reserva->descuento-$suma,2)}}</td>
              </tr>
              <tr><td colspan="4" ><button class='btn btn-light dim'></button> </td></tr>
              <tr>
                <th style="text-align: right" colspan="3" >TOTAL SALDO(Bs):</th>
                <th style="text-align: right;">{{number_format($reserva->total-$reserva->descuento-$suma,2)}}</th>
              </tr>
