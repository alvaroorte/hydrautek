    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="row">
                    <div class="col-lg-8">
                        <a href="#Nuevo" data-toggle="modal" class="config"><button class='btn btn-outline-secondary'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nueva Reserva</button></a>
                        <button type="button" class="btn btn-secondary">
                            <span class="badge bg-warning">{{$cantidad}}</span> <i class="far fa-calendar-edit"></i> Reservas Registradas
                        </button>
                        <a href="{{url('reservaServicioform')}}" class="config"><button class='btn btn-outline-secondary'><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Reserva de Servicio</button></a>
                    </div>
                ...
                <div class="ibox-content">
                    <div id="divCargaDistritos" class="table-responsive">
                        <table id="datatablereserva" class="table table-bordered table-hover table-striped table-sm">
                            <thead style="background:#42a8c7;color:#ffffff;text-align:center">
                                <tr>
                                    <th width=15%>CODIGO RESERVA</th>
                                    <th>FECHA</th>
                                    <th >CLIENTE</th>
                                    <th >TOTAL(Bs.)</th>
                                    <th >SALDO(Bs.)</th>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                    <td style="text-align: center;">{{$reserva->codigo_reserva}}</td>
                                    <td style="text-align: center;">{{$reserva->fecha}}</td>
                                    <td style="text-align: center;">{{$reserva->cliente}} ({{$reserva->nit_cliente}})</td>    
                                    <td style="text-align: center;">{{$reserva->total-$reserva->descuento}}</td> 
                                    <td style="text-align: center;">{{$reserva->saldo}}</td>
                                    @if ($reserva->estado)
                                        <td style="text-align: center;"> <button class='btn btn-warning'>Pendiente</button></td>
                                    @else
                                        <td style="text-align: center;"> <button class='btn btn-success'>Vendido</button></td>
                                    @endif                              
                                    <td style="text-align: center;"> <a href="{{'reservadetallada/'.$reserva->identificador}}"><button class='btn btn-info'>Ver Detalle</button></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<div class="modal fade" id="Nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content panel-primary">
            ...
            <form class="form-horizontal crearreserva" role="form" method="POST" action="{{('crearreserva')}}" autocomplete="off">
                {{ csrf_field() }}
                <div class="modal-content panel-primary">
                    <div class="modal-body">
...
$('.crearreserva').submit(function(e){
        e.preventDefault();

        Swal.fire({
        title: 'Estas Seguro?',
        text: "Estas a punto de Crear una Reserva!",
        icon: 'warning',
