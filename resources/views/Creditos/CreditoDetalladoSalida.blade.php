...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-6" >
        <h4>DETALLE DEL CREDITO DE VENTA</h4>
    </div>
    <div class="col-lg-6">
                            ...
                            <tbody>
                              <tr class="gradeC">
                                    ...
                                    <table class="table table-bordered table-hover table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeC">
                                                ...
                                                <td style="text-align: center;">{{$salida->nombre_bien}}, {{$salida->nombre_articulo}} ({{$salida->marca}})</td>
                                ...
                                <table id="datatablecreditodet" class="table table-bordered table-hover table-striped table-sm">
                                    ...
                                    <tbody>
                                        <?php $u = 1 ?>
                                        @foreach($salidas as $sqls)
                                        <tr class="gradeC">
                                            <td style="text-align: center;">{{$u}}</td>
                                            <td style="text-align: center;">{{$sqls->nombre_bien}}</td>
                                            <td style="text-align: center;">{{$sqls->nombre}}</td>
                                            <td style="text-align: center;">{{$sqls->marca}}</td>
                                            <td style="text-align: center;">{{$sqls->cantidad}}</td>
                                            <td style="text-align: center;">{{$sqls->p_venta}}</td>
                                            <td style="text-align: center;"> <h5> {{$sqls->sub_total}} </h5></td>
                                            <?php $u++;?>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <form class="form-horizontal crearpago" role="form" method="POST" action="{{url('crearpago')}}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <input type="text" name="cliente" id="cliente" value="{{$cliente->nombre}} ({{$cliente->ci}})" class='form-control' required readonly>
                        </div>
                        <div class="col-lg-2 ">
