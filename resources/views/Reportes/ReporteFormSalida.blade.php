...
@section('content')    
        <div class="modal-content panel-primary">
            <div class="modal-header panel-heading">
                ...
                <h4 class="modal-title">REPORTES VENTAS</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('reportefechasalida')}}" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div id="personalizado" style="display: none; font-size: 12pt">
                        <div class="row">
                            ...
                            <div>
                                <label>
                                    <input type="radio" name="tipo_venta" value="1" checked> Ambos
                                </label><br>
                                <label>
                                    <input type="radio" name="tipo_venta" value="VP-"> Venta de Productos
                                </label><br>
                                <label>
                                    <input type="radio" name="tipo_venta" value="VS-"> Venta de Servicios
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div>
                                <label>
                                    <input type="radio" id="tipo_pago" name="documento" value="2" checked> Ambos
                                </label><br>
                                <label>
                                    <input type="radio" id="tipo_pago1" name="documento" value="True" > Factura
                                </label><br>
                                <label>
                                    <input type="radio"  id="tipo_pago2" name="documento" value="False"> Nota Remision
                                </label>
                            </div>
                        </div>
                        <div class="row" id="div_tipo_pago" style="font-size: 11pt">
                            <div class="col-lg-3"></div>
                            <div>
                                    <label>
                                        <input type="radio" name="pago" value="3" checked> todos
                                    </label><br>
                                    <label>
