...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="col-lg-8">
                    <a href="{{url('mostrarcaja')}}" class="config" ><button class='btn btn-light' style="background:#3c46d3;color:#ffffff;text-align:center"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Volver</button></a>                     
                ...
                <div class="ibox-content">
                    <div class="table-responsive">  
                        <table id="datatablecajafecha" class="table table-bordered table-hover table-striped table-sm">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content panel-primary">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" action="{{url('crearcaja')}}" autocomplete="off">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-3">
                            <strong>FECHA</strong>
